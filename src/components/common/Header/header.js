...
const Header = ({ backgroundColor = "white" }) => {
  ...
  const Nav = () => (
    <nav>
      <StyledLink color={textColor} activecolor={activeColor} to="/portafolio">
        Portafolio
      </StyledLink>
      <StyledLink color={textColor} activecolor={activeColor} to="/servicios">
        Servicios
      </StyledLink>
      <StyledLink color={textColor} activecolor={activeColor} to="/nosotros">
        Nosotros
      </StyledLink>
      <StyledLink
        color={activeColor}
        activecolor={activeColor}
        to="/nosotros#contact-form"
      >
        Contactanos
      </StyledLink>
    </nav>
  ...
  return (
    <StyledHeader backgroundColor={backgroundColor}>
      <StyledLink activecolor={activeColor} to="/">
        <Logo
          color={breakpoints.tablet ? textColor : burgerIconColor}
          size="1.8em"
        />
      </StyledLink>
      {breakpoints.tablet ? (
